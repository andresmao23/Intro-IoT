...
class BotWhatsapp:
    def __init__(self):
        self.path_driver = r"C:\Users\CajaCVS\Desktop\notas\chromedriver.exe" # Settear la ruta del chromedriver en el PC 
    ...
    def start_browser(self):
        ...
        self.browser = webdriver.Chrome(executable_path=self.path_driver, chrome_options=options)
        self.browser.get(self.base_url)
        try:
            WebDriverWait(self.browser, self.timeout).until(EC.presence_of_element_located((By.CSS_SELECTOR, self.base_input)))
            return True
...
obj = BotWhatsapp()
obj.send_message_to_contact('573012234677', 'Mao te saluda desde Selenium!!!')
